...
- Trong mỗi RPC request, client sẽ gửi *message* với 2 thuộc tính: `reply_to` dùng để nhận biết là `callback_queue` va `correlation_id` để đặt giá trị duy nhất cho mỗi lần request.
...
Trên đây, tôi đã hoàn thành xong phần tìm hiểu Getting Started với RabbitMQ. Để xem bài hướng daxn gốc, vui lòng bấm vào [đây] (https://www.rabbitmq.com/getstarted.html).
